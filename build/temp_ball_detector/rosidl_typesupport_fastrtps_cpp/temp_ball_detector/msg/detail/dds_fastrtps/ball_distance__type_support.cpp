...
#include "temp_ball_detector/msg/detail/ball_distance__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = temp_ball_detector::msg::BallDistance;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const temp_ball_detector::msg::BallDistance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<temp_ball_detector::msg::BallDistance *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_temp_ball_detector
const rosidl_message_type_support_t *
get_message_type_support_handle<temp_ball_detector::msg::BallDistance>()
{
  return &temp_ball_detector::msg::typesupport_fastrtps_cpp::_BallDistance__handle;
}
