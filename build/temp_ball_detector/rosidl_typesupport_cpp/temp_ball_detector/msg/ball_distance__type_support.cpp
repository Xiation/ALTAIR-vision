...
static const _BallDistance_type_support_symbol_names_t _BallDistance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, temp_ball_detector, msg, BallDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, temp_ball_detector, msg, BallDistance)),
  }
};
...
{
  return &::temp_ball_detector::msg::rosidl_typesupport_cpp::BallDistance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, temp_ball_detector, msg, BallDistance)() {
  return get_message_type_support_handle<temp_ball_detector::msg::BallDistance>();
}
