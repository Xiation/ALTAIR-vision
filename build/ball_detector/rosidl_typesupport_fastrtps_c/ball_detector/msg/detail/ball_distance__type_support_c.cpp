...
#include "ball_detector/msg/detail/ball_distance__rosidl_typesupport_fastrtps_c.h"
...
using _BallDistance__ros_msg_type = ball_detector__msg__BallDistance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ball_detector__msg__BallDistance;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ball_detector__msg__BallDistance * ros_message = static_cast<const ball_detector__msg__BallDistance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ball_detector__msg__BallDistance(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ball_detector__msg__BallDistance * ros_message = static_cast<ball_detector__msg__BallDistance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ball_detector__msg__BallDistance(cdr, ros_message);
}

static uint32_t _BallDistance__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ball_detector__msg__BallDistance(
...
static size_t _BallDistance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ball_detector__msg__BallDistance(
