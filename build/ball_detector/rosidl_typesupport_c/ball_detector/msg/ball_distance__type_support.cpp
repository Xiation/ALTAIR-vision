...
static const _BallDistance_type_support_symbol_names_t _BallDistance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ball_detector, msg, BallDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ball_detector, msg, BallDistance)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ball_detector, msg, BallDistance)() {
  return &::ball_detector::msg::rosidl_typesupport_c::BallDistance_message_type_support_handle;
}
