...
#include "ball_detect/msg/detail/ball_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ball_detect::msg::BallInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ball_detect::msg::BallInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ball_detect::msg::BallInfo *>(
    untyped_ros_message);
...
static size_t _BallInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BallInfo(full_bounded, is_plain, 0);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ball_detect
const rosidl_message_type_support_t *
get_message_type_support_handle<ball_detect::msg::BallInfo>()
{
  return &ball_detect::msg::typesupport_fastrtps_cpp::_BallInfo__handle;
}
