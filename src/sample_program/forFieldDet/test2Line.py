...
# the thinning process would need the image with roi extracted
...
if __name__ == "__main__":
    ...
    # call out the thinning algorithm
    thinned_line = zhangsuen(line_masked)
    
    display_results(original_image, roi_image, green_mask_cleaned, line_masked, thinned_line)
